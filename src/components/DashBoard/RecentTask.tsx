...
const RecentTask = () => {
  ...
  const columns = [
    { name: '번호', width: '60px', columnHeight: '22px', rowHeight: '7px' },
    { name: '고유번호', width: '100px', columnHeight: '22px', rowHeight: '7px' },
    { name: '상품명', width: '140px', columnHeight: '22px', rowHeight: '7px' },
    { name: '작업날짜', width: '160px', columnHeight: '22px', rowHeight: '7px' },
  ];
